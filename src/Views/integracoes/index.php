...
<div class="grid-3">
    <div class="card">
        ...
        <form method="post" action="/integracoes">
            ...
            <div class="form-group">
                ...
                <input class="input" name="client_secret" type="password" value="<?= htmlspecialchars($openFinance['config']['client_secret'] ?? '') ?>" placeholder="Client Secret">
            </div>
            <div class="form-group">
    ...
    <div class="card">
        ...
        <form method="post" action="/integracoes">
            ...
            <div class="form-group">
                <label>API Key</label>
                <input class="input" name="api_key" type="password" value="<?= htmlspecialchars($gateway['config']['api_key'] ?? '') ?>" placeholder="Chave da API">
            </div>
            <div class="form-group">
    ...
    <div class="card">
        ...
        <form method="post" action="/integracoes">
            ...
            <div class="form-group">
                <label>Token</label>
                <input class="input" name="token" type="password" value="<?= htmlspecialchars($nfse['config']['token'] ?? '') ?>" placeholder="Token de acesso">
            </div>
            <label class="filter-label" style="display:flex;align-items:center;gap:8px;margin-bottom:12px">
